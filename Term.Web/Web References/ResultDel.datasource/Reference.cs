...
namespace Term.Web.ResultDel.datasource {
    using System;
    ...
    public partial class ServiceTerminal : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ServiceTerminal() {
            this.Url = global::Term.Web.Properties.Settings.Default.YstProject_WebReferenceTerm_ServiceTerminal;
        ...
        public Result CreateOrder(string Partner, string PointId, [System.Xml.Serialization.XmlArrayItemAttribute("Products", Namespace="http://37.1.84.50:8080/Terminal", IsNullable=false)] Product[] Goods, string Comment) {
        ...
        /// <remarks/>
        public void CreateOrderAsync(string Partner, string PointId, Product[] Goods, string Comment) {
            this.CreateOrderAsync(Partner, PointId, Goods, Comment, null);
        }
        
        /// <remarks/>
        public void CreateOrderAsync(string Partner, string PointId, Product[] Goods, string Comment, object userState) {
            ...
            this.InvokeAsync("CreateOrder", new object[] {
                        ...
                        PointId,
                        Goods,
                        Comment}, this.CreateOrderOperationCompleted, userState);
        }
